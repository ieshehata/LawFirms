...
import com.app.lawfirms.activities.general.ChatActivity;
...
public class ConversationAdapter extends RecyclerView.Adapter<ConversationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (!TextUtils.isEmpty(other.getProfileImage())) {
            ...
            holder.profileImage.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(context, R.color.colorPrimary)));
